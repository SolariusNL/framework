...
const Faq: FC = () => {
  ...
  return (
    <div
      className="py-16 my-16 mx-auto rounded-3xl"
      style={{
        backgroundColor:
          theme.colorScheme === "dark"
            ? theme.colors.dark[9]
      ...
      <Container>
        ...
        <Accordion variant="separated">
          <Accordion.Item className={classes.item} value="reset-password">
            ...
            <Accordion.Panel>
              At this time, Framework is in a closed, invite-only period. You
              can request an invite code by{" "}
              <Anchor href="mailto:invite@solarius.me">
                reaching out to us
              </Anchor>{" "}
          ...
          <Accordion.Item className={classes.item} value="credit-card">
            ...
            <Accordion.Panel>
              Framework has an on-platform currency called Tickets. Tickets can
              be used to purchase in-game items, and can be purchased with real
              money. We also have a premium subscription called Framework
              Premium, which grants you access to exclusive features.
            </Accordion.Panel>
          </Accordion.Item>
          ...
          <Accordion.Item className={classes.item} value="payment">
            ...
            <Accordion.Panel>
              ...
              app. Our backend is a mix between Next.js&apos;s API routes and
              Rust to power the website, server logistics, and many other
              functionalities.
              <br />
              <br />
              We use PostgreSQL as our database, and Redis for caching. We also
              use a variety of other technologies, such as Docker, Kubernetes,
              and MinIO.
              <br />
              <br />
